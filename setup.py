...
def get_hash():
    if os.path.exists('.git'):
        ...
        try:
            from nfdp.version import __version__
...
if __name__ == '__main__':
    ...
    setup(
        name='nfdp',
        version=get_version(),
        description='Code for Landmark Localization from Medical Images with Generative Distribution Prior',
